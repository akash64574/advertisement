...
<div class="container">
 ...
 <main>
    <template is="dom-repeat" items={{availableSlots}}>
        <paper-card >
                <div id="first">
                    <h2>Pragramme Name: <span id="blue">{{item.programmeName}}</span></h2>
                </div>
                <div id="second">
                ...
                <div id="third">
                    ...
                    <h3>Status: <span id="green">{{item.status}}</span></h3>
                </div>
        </paper-card>
    </template>
</main>
    <paper-dialog id="slot">
        ...
        <br>
            ...
            <datetime-picker  id="fromDateTime" auto-confirm datetime="{{min}}" max="{{max}}" date="{{fromDate}}"
            time="{{fromTime}}" ></datetime-picker>
            <br>
            <h4>Select To Date Time</h4>
            <datetime-picker  id="toDateTime" auto-confirm datetime="{{max}}" min="{{min}}" date="{{toDate}}" time="{{toTime}}" ></datetime-picker>
            <br>
            <h4>Choose Plan:</h4>
